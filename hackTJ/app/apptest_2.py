...
def hello():
    ...
    return render_template('category_listing.html')
#,category1=names[0])#,category2=names[1],category3=names[2],category4=names[3],category5=names[4])
